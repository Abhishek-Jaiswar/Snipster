      ...
      <div className='flex gap-2 items-center p-3'>
        ...
        <div className='flex items-center justify-start gap-3 flex-1'>
          ...
          <div className='relative'>
            <button
              ...
              <IoIosArrowDown className={`${isDropDownOpen ? "rotate-0 transition-all duration-500" : "-rotate-90 transition-all duration-500"} text-2xl mt-2`} />
            </button>
            {isDropDownOpen && (
              <div className='absolute p-4 transition-all duration-500 bg-white w-28 rounded-md shadow-sm border'>
        ...
        <div>
          <div className='flex items-center justify-center gap-2'>
            <Button variant={'outline'} className='flex items-center justify-center text-sm text-gray-800 gap-2'>
